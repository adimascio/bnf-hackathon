...
import { loadOAI } from '../actions/oai'
...
class OAIDetails extends Component {
...
OAIDetails.propTypes = {
  url: PropTypes.string.isRequired,
  gallica: PropTypes.object
}

export default connect(mapStateToProps, mapDispatchToProps)(OAIDetails)